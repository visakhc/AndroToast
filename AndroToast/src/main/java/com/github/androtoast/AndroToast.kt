...
//    todo add option to set custom size for imageview
    ...
    companion object {
        ...
        fun start(context: Context) {
            ...
            takeIf { layout == R.layout.androtoast }?.apply {
            ...
            if (gravity == null && xOffset == null && yOffset == null) {
                toast.setGravity(defGravity, defX, defY)
            } else if (gravity == null && xOffset == null && yOffset != null) {
                toast.setGravity(defGravity, defX, yOffset!!)
            } else if (gravity == null && xOffset != null && yOffset == null) {
                toast.setGravity(defGravity, xOffset!!, defY)
            } else if (gravity == null && xOffset != null && yOffset != null) {
                toast.setGravity(defGravity, defX, yOffset!!)
            } else if (gravity != null && xOffset == null && yOffset == null) {
                toast.setGravity(gravity!!, defX, defY)
            } else if (gravity != null && xOffset == null && yOffset != null) {
                toast.setGravity(gravity!!, defX, yOffset!!)
            } else if (gravity != null && xOffset != null && yOffset == null) {
                toast.setGravity(gravity!!, xOffset!!, defY)
            } else if (gravity != null && xOffset != null && yOffset != null) {
